...
public class ShadowLayout extends FrameLayout {
    ...
    private void initAttributes(AttributeSet attrs) {
        ...
        try {
            ...
            mCornerRadius = attr.getDimension(R.styleable.ShadowLayout_hl_cornerRadius, getResources().getDimension(R.dimen.size_0));
            //默认扩散区域宽度
            mShadowLimit = attr.getDimension(R.styleable.ShadowLayout_hl_shadowLimit, getResources().getDimension(R.dimen.size_5));
...
//            canvas.drawRoundRect(rectf, mCornerRadius, mCornerRadius, paintStroke);
    ...
    public void isAddAlpha(int color) {
        ...
        if (Color.alpha(color) == 255) {
            ...
            String endColor = "#40" + red + green + blue;
