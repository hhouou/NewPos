...
public class PickerView extends View {
    ...
    private void initPaint() {
        ...
        mLightColor = ContextCompat.getColor(mContext, R.color.grey_5B);
        mDarkColor = ContextCompat.getColor(mContext, R.color.grey_75);
    }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        float maxTextSize = height / 7.8f;
        mMinTextSize = maxTextSize / 2f;
        mTextSizeRange = maxTextSize - mMinTextSize;
        mTextSpacing = mMinTextSize * 3f;
