...
public class WsManager {
    ...
    public void init() {
        try {
             ...
             */
            String baseUrl = BuildConfig.API_BASE_URL.replaceAll("https", "wss");
            url = baseUrl + "app/pay/detail/" + App.getToken();
            ws = new WebSocketFactory()
                    .createSocket(url, CONNECT_TIMEOUT)
    ...
    class WsListener extends WebSocketAdapter {
        ...
        public void onTextMessage(WebSocket websocket, String text) throws Exception {
            ...
            if (text.equals("success")){
                ...
                RxBus.getDefault().post(new StatusEvent(2));
            }
