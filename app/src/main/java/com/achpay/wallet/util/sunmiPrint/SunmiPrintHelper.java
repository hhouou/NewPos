package com.achpay.wallet.util.sunmiPrint;
...
public class SunmiPrintHelper {
    ...
    public void printSummary(Context mContext, String startTime, String endTime, TradeSummaryReponse reponse) {
        ...
        String number = reponse.getPayTotal();
        List<TradeSummaryReponse.ListBean> mList = reponse.getList();
        ...
        try {
            ...
            sunmiPrinterService.printTextWithFont("Start Time\n", null, 18, null);

            sunmiPrinterService.setPrinterStyle(WoyouConsts.ENABLE_BOLD, WoyouConsts.ENABLE);
            sunmiPrinterService.printTextWithFont(startTime + "\n", null, 20, null);


            sunmiPrinterService.setPrinterStyle(WoyouConsts.SET_LINE_SPACING, 0);
            sunmiPrinterService.printTextWithFont("End Time\n", null, 18, null);

            sunmiPrinterService.setPrinterStyle(WoyouConsts.ENABLE_BOLD, WoyouConsts.ENABLE);
            sunmiPrinterService.printTextWithFont(endTime + "\n", null, 20, null);

            sunmiPrinterService.setPrinterStyle(WoyouConsts.SET_LINE_SPACING, 0);
            sunmiPrinterService.printTextWithFont("Receipt Reference Number\n", null, 18, null);

            sunmiPrinterService.setPrinterStyle(WoyouConsts.ENABLE_BOLD, WoyouConsts.ENABLE);
            sunmiPrinterService.printTextWithFont(number + "\n", null, 20, null);

            sunmiPrinterService.lineWrap(1, null);
            sunmiPrinterService.printText("--------------------------------\n", null);


            sunmiPrinterService.setPrinterStyle(WoyouConsts.ENABLE,0);
            sunmiPrinterService.setFontSize(18, null);
            String txts[] = new String[]{"Type", "Entries", "Amount"};
            ...
            for (TradeSummaryReponse.ListBean item : mList) {
                ...
                sunmiPrinterService.printColumnsString(trade, width, align, null);
            }
            sunmiPrinterService.printText("------------------------------------------\n", null);

            String tradeAll[] = new String[]{"Summary", reponse.getPayTotal(), App.getInstance().getCurrencyCode()+" "+ reponse.getTotalAmount()};
            sunmiPrinterService.printColumnsString(tradeAll, width, align, null);
     ...
     */
    public void printOrder(Context mContext, PayOrderReponse payOrder, String coinName) {
        if (sunmiPrinterService == null) {
            //TODO Service disconnection processing
            return;
        }
        ...
        try {
            ...
            if (TextUtils.equals(merchantCode, "ME1653973679011")) {
                Bitmap bitmap4 = BitmapFactory.decodeResource(mContext.getResources(), R.drawable.icon_print_logo_artaverse);
                sunmiPrinterService.printBitmap(bitmap4, null);
            ...
            sunmiPrinterService.printTextWithFont(mContext.getString(R.string.print_merchant) + merchantName + "\n", null, 20, null);
            sunmiPrinterService.printTextWithFont(mContext.getString(R.string.print_merchant_no) + merchantCode + "\n", null, 20, null);
            sunmiPrinterService.printTextWithFont(mContext.getString(R.string.print_fiat_amount) + payAmpunt + " " + payAmountUnit + "\n", null, 20, null);
            sunmiPrinterService.printTextWithFont(mContext.getString(R.string.print_payment_method) + coinName + "\n", null, 20, null);
            sunmiPrinterService.printTextWithFont(mContext.getString(R.string.print_digital_amount) + payAcount + " " + payAcounttUnit + "\n", null, 20, null);
            sunmiPrinterService.printTextWithFont(mContext.getString(R.string.print_ordernum) + orderNum + "\n", null, 20, null);
            sunmiPrinterService.printTextWithFont(mContext.getString(R.string.print_date) + createTime + "\n", null, 20, null);
...
//            sunmiPrinterService.lineWrap(1, null);
     ...
     * Sample print receipt
     */
    public void printOrder(Context mContext, String sysOrderNum, String fiatAmount,String payAmountUnit,String payTime) {
        if (sunmiPrinterService == null) {
            //TODO Service disconnection processing
            return;
        }
        ...
        try {
            ...
            sunmiPrinterService.printTextWithFont(mContext.getString(R.string.print_merchant) + merchantName + "\n", null, 20, null);
            sunmiPrinterService.printTextWithFont(mContext.getString(R.string.print_merchant_no) + merchantCode + "\n", null, 20, null);
            sunmiPrinterService.printTextWithFont(mContext.getString(R.string.print_fiat_amount) + fiatAmount + " " + payAmountUnit + "\n", null, 20, null);
            sunmiPrinterService.printTextWithFont(mContext.getString(R.string.print_ordernum) + sysOrderNum + "\n", null, 20, null);
            sunmiPrinterService.printTextWithFont(mContext.getString(R.string.print_date) + payTime + "\n", null, 20, null);
...
//            sunmiPrinterService.lineWrap(1, null);
     ...
     * 答应汇率
     */
    public void printExchangeRate(Context mContext, double fiatAmount, String fiatName, double coinAmount, String coinName) {
        if (sunmiPrinterService == null) {
            //TODO Service disconnection processing
            return;
        }
        ...
        try {
            ...
            sunmiPrinterService.printTextWithFont(mContext.getString(R.string.print_merchant) + merchantName + "\n", null, 20, null);
            sunmiPrinterService.printTextWithFont(mContext.getString(R.string.print_merchant_no) + merchantCode + "\n", null, 20, null);
            sunmiPrinterService.printTextWithFont(mContext.getString(R.string.print_fiat_amount) + fiatAmount + " " + fiatName + "\n", null, 20, null);
//            sunmiPrinterService.printTextWithFont(mContext.getString(R.string.print_payment_method) + coinName+"\n", null,20, null);
            sunmiPrinterService.printTextWithFont(mContext.getString(R.string.print_digital_amount) + coinAmount + " " + coinName + "\n", null, 20, null);
            sunmiPrinterService.printTextWithFont(mContext.getString(R.string.print_date) + TimeUtils.getnowtime(null, mContext) + "\n", null, 20, null);
