...
import com.achpay.wallet.util.print.BTPrinterCommand;
...
public class USBPrinting extends SimpleActivity {
    ...
    protected int getLayout() {
        return R.layout.activity_btprinter;
    }
